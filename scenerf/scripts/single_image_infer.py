...
def main():
    # 设置参数
    model_path = "C:/Users/Bruce Wayne/Downloads/scenerf_kitti.ckpt"  # 模型路径
    img_path = "C:/Users/Bruce Wayne/Downloads/building.jpg"     # 输入图像路径
    save_dir = "D:/workspace/SceneRF-main/results/reconstruction/colors"          # 保存结果路径
